    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='positions.department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(blank=True, null=True)),
                ('gender', models.CharField(choices=[('F', 'Female'), ('M', 'Male')], max_length=10)),
                ('relation', models.CharField(choices=[('Father', 'father'), ('Son', 'son'), ('Wife', 'wife'), ('Husband', 'husband'), ('Sister', 'sister'), ('Mother', 'motherr'), ('Brother', 'brother'), ('Daughter', 'daughter')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('department', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='positions.department')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
